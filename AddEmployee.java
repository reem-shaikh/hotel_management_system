...
import java.awt.*;
import java.awt.event.*;    //this package includes action listener
import java.sql.*;
import javax.swing.*;
...
public class AddEmployee extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            JButton Next = new JButton("SAVE");    //submit button
			//we need to implement an event when user clicks on this button
			//this is implemented using action listener *scroll up
            ...
            c1 = new JComboBox(course);    //create combo box object for dropdown
			//combobox takes array of string "course"
            ...
            Image i3 = i1.getImage().getScaledInstance(500, 500,Image.SCALE_DEFAULT); //fixing image size
            ImageIcon i2 = new ImageIcon(i3);  //placing it back in image icon
			
            JLabel image = new JLabel(i2);   //placing image on label
...
//in interfaces methods can  only be declared; not defined
//in order to define interfaces 

//so whichever interface is defined it must be override - method overidding
			 public void actionPerformed(ActionEvent ae){
                    ...
                    try {
						...
						//to enter details in db entered by user
